...
class UserCognitoDTO:
    ...
    def __init__(self, user_id: int, name: str, email: str, phone: str, role: ROLE,
        user_status: USER_STATUS, created_at: str, updated_at: str, email_verified: bool, enabled: bool):
