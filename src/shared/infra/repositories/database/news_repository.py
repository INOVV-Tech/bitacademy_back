...
class NewsRepositoryDynamo(INewsRepository):
    ...
    def create(self, news: News) -> News:
        ...
        item[encode_idx_pk('GSI#ENTITY_GETALL')] = self.news_gsi_primary_key()
        item[encode_idx_pk('GSI#TEXT')] = news.title
    ...
    def get_all(self, tags: list[str] = [], vip_level: VIP_LEVEL | None = None, \
        ...
        response = self.dynamo.query(
            ...
            partition_key=self.news_gsi_primary_key(),
            limit=limit,
